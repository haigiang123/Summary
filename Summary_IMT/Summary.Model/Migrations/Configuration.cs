...
namespace Summary.Model.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<SummaryDbContext>
    {
        ...
        private void CreateConfigTitle(SummaryDbContext context)
        {
        ...
        private void CreateSize(SummaryDbContext context)
        {
        ...
        private void CreateColor(SummaryDbContext context)
        {
        ...
        //private void CreateFooter(SummaryDbContext context)
        //{
        ...
        private void CreateSlide(SummaryDbContext context)
        {
        ...
        private void CreatePage(SummaryDbContext context)
        {
        ...
        private void CreateContactDetail(SummaryDbContext context)
        {
            if (context.ContactDetails.Count() == 0)
            {
                try
                {
                    var contactDetail = new Summary.Model.Models.ContactDetail
                    {
